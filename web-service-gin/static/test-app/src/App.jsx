...
import { PageCatalog, PagePayment, PageDelivey, PageOffers, PageSupport, PageAbout, PageLogin, PageRegister, PagePersonal, PageCart, PageItem, PageAdmin, PageItemForm, PageCategoryForm } from './Pages';
      ...
      <CartProvider>
        ...
        <Routes>
          <Route path="/" element={<MainPage />} >
              ...
              <Route path="adminItem"       element={<PageItemForm     />} />
              <Route path="adminCategories" element={<PageCategoryForm />} />
            </Route>
        </Routes>
        </BrowserRouter>
      </CartProvider>
